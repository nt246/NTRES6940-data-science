...
There are no required readings for today, but if you did not join our Zoom call last Wednesday, please read through the [lecture notes](https://nt246.github.io/NTRES6940-data-science/lesson4-collaboration.html) and watch the recording posted on Canvas
...
Have Partner 2 create and knit the `index.Rmd` file as described above, and push it to GitHub (pull, stage, commit, push)
