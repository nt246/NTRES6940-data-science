...
Let's start with summarizing the total number of cases by type as of `r max(coronavirus$date)`. Take a minute to try this for yourself, then you can look at our approach.
