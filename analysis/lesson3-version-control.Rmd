...
knitr::include_graphics("assets/gh_repo_clone1.png")  
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("assets/issues_ggplot2.png")  
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("assets/issues_MozillaFestival.png")  
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("assets/issues_globalfellows.png")  
```
