...
-   [Learning objectives for today's class](#learning-objectives-for-todays-class)
-   [Introduction to RMarkdown](#introduction-to-rmarkdown)
    -   [Create an RMarkdown file](#create-an-rmarkdown-file)
    -   [Knit your RMarkdown file](#knit-your-rmarkdown-file)
    -   [Markdown text](#markdown-text)
    -   [R code](#r-code)
    -   [Code chunks](#code-chunks)
    -   [Error messages](#error-messages)
    -   [Running RMarkdown code chunks](#running-rmarkdown-code-chunks)
    -   [Writing code in a file vs. Console](#writing-code-in-a-file-vs.-console)
-   [GitHub brief intro & config](#github-brief-intro-config)
    -   [Configure GitHub](#configure-github)
    -   [Ensure that Git/GitHub/RStudio are communicating](#ensure-that-gitgithubrstudio-are-communicating)
    -   [Troubleshooting](#troubleshooting)
    -   [END **RMarkdown/GitHub** session!](#end-rmarkdowngithub-session)
...
- The [Rmd website](https://rmarkdown.rstudio.com/) has a fantastic walk-through [tutorial](https://rmarkdown.rstudio.com/lesson-1.html) that gives a great overview of R Markdown - Yihui's [Rmd book](https://bookdown.org/yihui/rmarkdown/) for lots more on R Markdown.
...
To show a figure from a url or your local computer, use `![caption](url_or_path_to_image)`
