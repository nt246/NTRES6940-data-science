---
title: "Lesson 12: Iteration with `for` loops and conditional execution with `if` statements"
...
## Announcements
The final homework assignment has been posted. It is due next Wednesday May 6 at 10pm

Next class (Monday May 4) will be our last. There will be a recorded lecture and a Zoom call from 5.10-5.40pm. We will cover the following topics:
