...
> Take a minute to think about how you would split generate a plot with
> a separate line showing the daily reports of new confirmed cases in
> each country.
...
`geom_col()` as we already did above.
