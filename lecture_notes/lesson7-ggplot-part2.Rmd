...
This overview is borrowing from the [STAT545 course at UBC](https://stat545guidebook.netlify.com/intro-to-plotting-with-ggplot2-part-i.html)
...
#### Your turn
> Take a minute to think about how you would split generate a plot with a separate line showing the daily reports of new confirmed cases in each country.
...
Since our dataset reports counts of cases, let's first start with `geom_col()` as we already did above.
